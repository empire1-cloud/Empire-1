...
export default function GTMPage() {
  const [view, setView] = useState<'operations' | 'viral'>('viral');
  ...
  return (
    <div className="min-h-screen bg-black">
      <div className="sticky top-0 z-40 border-b border-white/10 bg-black/90 px-5 py-3 backdrop-blur sm:px-8">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-zinc-500">Campaign operations and proof-backed content</p>
          </div>
          <div className="flex rounded-xl border border-white/10 bg-zinc-950 p-1">
            <button
      ...
      {view === 'viral' ? <ViralContentEngine /> : <div className="bg-gray-50 text-gray-900"><GTMPanel /></div>}
    </div>
  );
}
