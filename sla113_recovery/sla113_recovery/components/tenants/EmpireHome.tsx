...
import { Network, Terminal, Send, Code, Maximize, X } from 'lucide-react';

/**
 * EMPIRE ONE // OS_FACTORY_HUD
      ...
      <div className="pt-16 px-4 md:px-8 pb-32 max-w-[1600px] mx-auto relative z-10">
        ...
        <header className="grid grid-cols-1 lg:grid-cols-12 gap-4 mb-4">
          <div className="lg:col-span-3 border border-[#00e5ff]/20 bg-black/40 p-4 relative tech-border">
            ...
            <h1 className="text-xl font-black tracking-widest text-white uppercase">OS_FACTORY</h1>
          </div>
          <div className="hidden lg:flex lg:col-span-7 border border-[#00e5ff]/20 bg-black/40 p-4 items-center justify-between tech-border font-mono text-[10px] text-white/50 tracking-widest">
            ...
            <a href="#matrix" className="hover:text-[#00e5ff] transition-colors">[ ALLOCATION_MATRIX ]</a>
          </div>
          <div className="lg:col-span-2 border border-[#00e5ff]/20 bg-[#00e5ff]/10 p-4 flex items-center justify-center tech-border hover:bg-[#00e5ff]/20 cursor-pointer transition-colors">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-4 mb-4 min-h-[60vh]">
          <div className="lg:col-span-5 flex flex-col justify-end border border-[#00e5ff]/20 bg-black/60 p-8 tech-border relative overflow-hidden">
            ...
            <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter text-white leading-none mb-6">
              BUILD <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00e5ff] to-white/50">INFRA.</span>
            </h2>
            <p className="font-mono text-xs text-white/60 leading-relaxed mb-10 max-w-md border-l-2 border-[#00e5ff]/50 pl-4">
              &gt; MANUFACTURE PRODUCTION SYSTEMS AUTOMATICALLY.<br/>
              &gt; ORCHESTRATE MULTI-TENANT ENVIRONMENTS.<br/>
              &gt; DEPLOY SOVEREIGN WHITE-LABEL NODES.
            </p>
            ...
            <div className="flex gap-4">
              ...
              <button onClick={() => setIsChatOpen(true)} className="flex-1 border border-[#00e5ff]/30 text-[#00e5ff] font-mono font-bold text-[10px] uppercase tracking-[3px] py-4 text-center hover:bg-[#00e5ff]/10 transition-colors">
                [ COM_LINK ]
              </button>
            </div>
          </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          {[
            ...
            { id: "0x2B", title: "AUTO_BUILDER", desc: "Event-driven dependency injection and pipeline execution.", val: "OK" },
            { id: "0x3C", title: "MULTI_TENANT", desc: "Isolated white-label infrastructure. Central governance.", val: "SECURE" }
          ].map((f, i) => (
            <div key={i} className="border border-[#00e5ff]/20 bg-black/40 p-6 tech-border hover:bg-[#00e5ff]/5 transition-colors">
              <div className="flex justify-between items-center mb-6">
                <span className="text-[10px] font-mono text-[#00e5ff]">{f.id}</span>
                <span className="text-[10px] font-mono text-white/50 bg-white/5 px-2 py-1">{f.val}</span>
              </div>
              <h3 className="text-sm font-black uppercase tracking-widest text-white mb-3">{f.title}</h3>
              <p className="font-mono text-[10px] text-white/50 leading-relaxed">&gt; {f.desc}</p>
            </div>
          ))}
        </section>
        ...
        <section id="matrix" className="border border-[#00e5ff]/20 bg-black/40 p-1 tech-border mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 divide-y lg:divide-y-0 lg:divide-x divide-[#00e5ff]/20">
            {[
              ...
              <div key={i} className={`p-8 relative ${node.active ? 'bg-[#00e5ff]/5 shadow-[inset_0_0_50px_rgba(0,229,255,0.05)]' : 'hover:bg-white/[0.02]'}`}>
                ...
                <button className={`w-full py-3 font-mono text-[10px] tracking-widest uppercase border ${node.active ? 'bg-[#00e5ff] border-[#00e5ff] text-black hover:bg-white hover:border-white' : 'border-white/20 text-white hover:border-[#00e5ff] hover:text-[#00e5ff]'} transition-colors`}>
                  [ ALLOCATE_NODE ]
                </button>
              </div>
            ))}
          ...
          <div className="border-t border-[#00e5ff]/20 bg-black p-6 flex flex-col md:flex-row justify-between items-center gap-4">
             ...
             <button className="border border-[#00e5ff]/40 text-[#00e5ff] px-6 py-2 font-mono text-[9px] tracking-widest hover:bg-[#00e5ff]/10 transition-colors">
