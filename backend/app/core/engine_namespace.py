...
ENGINES = {
    ...
    "vision_smith": EngineMetadata(
        ...
        credit_cost=10,
        enabled_for=["EMPIRE1", "SLA113", "Southern", "lyrica3", "universal"],  # Full SaaS support
...
CANON_ENGINES = {
    "canon_identity_v1": EngineMetadata(
        ...
        credit_cost=5,
        enabled_for=["SLA113", "EMPIRE1", "lyrica3", "universal", "Southern"],  # SLA113 manufacture only — output delivered to Southern
    ...
    "aztec_chicano_engine": EngineMetadata(
        ...
        credit_cost=12,
        enabled_for=["SLA113", "EMPIRE1", "lyrica3", "universal", "Southern"],
...
ARCADE_ENGINES = {
    "fishing_engine_v2": EngineMetadata(
        ...
        credit_cost=2,
        enabled_for=["EMPIRE1", "tenant_casino_vegas", "tenant_arcade_london", "tenant_gaming_sydney",
                     "Southern", "southern_lyfestyle_arcade", "lyrica3", "universal"],  # Gaming tenants only
    ...
    "slots_engine_v1": EngineMetadata(
        ...
        credit_cost=2,
        enabled_for=["EMPIRE1", "tenant_casino_vegas", "tenant_arcade_london", "tenant_gaming_sydney",
                     "Southern", "horror_arcade", "anime_arcade", "lyrica3", "universal"],  # Gaming tenants only
    ...
    "keno_engine_v1": EngineMetadata(
        ...
        router="app.routers.arcade",
        credit_cost=1,
        enabled_for=["tenant_casino_vegas", "Southern", "EMPIRE1", "lyrica3", "universal"],  # Gaming tenants only
    ...
    "payout_engine": EngineMetadata(
        ...
        credit_cost=0,
        enabled_for=["EMPIRE1", "tenant_casino_vegas", "tenant_arcade_london", "tenant_gaming_sydney",
                     "southern_lyfestyle_arcade", "Southern", "horror_arcade", "anime_arcade", "SLA113", "lyrica3", "universal"],  # Southern arcade variants,
    ...
    "tenant_engine": EngineMetadata(
        ...
        router="app.routers.arcade",
        credit_cost=0,
        enabled_for=["EMPIRE1", "SLA113", "lyrica3", "universal", "Southern"],
    ...
    "canon_layer_sgv_aztec": EngineMetadata(
        ...
        router="app.routers.arcade",
        credit_cost=1,
        enabled_for=["Southern", "SLA113", "EMPIRE1", "lyrica3", "universal"],  # Southern identity layer | SLA113 manufacture
...
SLA113_CORE_ENGINES = {
    "playful_art_bible": EngineMetadata(
        ...
        router="app.routers.southern_engine_pack",
        credit_cost=0,
        enabled_for=["SLA113", "EMPIRE1", "lyrica3", "universal", "Southern"],  # Canon-locked — SLA113 internal only, injected into Southern builds
        description=(
    ...
    "entropy_engine": EngineMetadata(
        ...
        router="app.routers.arcade",
        credit_cost=0,
        enabled_for=["SLA113", "EMPIRE1", "lyrica3", "universal", "Southern"],  # Root kernel — /dev/shm only, governance-locked
        description=(
...
# ========================================================
    ...
    # Additional Empire1 Engines (50+ total)
    "beat_maker_engine": EngineMetadata(
        name="BeatMaker Pro",
        service="app.services.beat_maker",
        router="app.routers.engines.beat_maker",
        credit_cost=12,
        enabled_for=["EMPIRE1", "SLA113", "lyrica3", "universal"],
        description="Advanced beat making with AI assistance for Empire1",
        status="active",
        canon_lock=False,
        engine_type="revenue",
    ),
    "dj_engine": EngineMetadata(
        name="DJ Engine",
        service="app.services.dj",
        router="app.routers.engines.dj",
        credit_cost=15,
        enabled_for=["EMPIRE1", "SLA113", "lyrica3", "universal"],
        description="DJ mixing and playlist generation",
        status="active",
        canon_lock=False,
        engine_type="revenue",
    ),
    "character_creator_engine": EngineMetadata(
        ...
        service="app.services.character_creator",
        router="app.routers.engines.character_creator",
        credit_cost=20,
        enabled_for=["EMPIRE1", "SLA113", "Southern", "universal"],
        description="AI character generation for games and stories",
        status="active",
        canon_lock=False,
        engine_type="universal",
    ),
    "story_engine": EngineMetadata(
        name="Story Engine",
        service="app.services.story",
        router="app.routers.engines.story",
        credit_cost=18,
        enabled_for=["EMPIRE1", "SLA113", "Southern", "universal"],
        description="AI story generation with plot branching",
        status="active",
        canon_lock=False,
        engine_type="universal",
    ),
    "vibe_engine": EngineMetadata(
        name="Vibe Engine",
        service="app.services.vibe",
        router="app.routers.engines.vibe",
        credit_cost=10,
        enabled_for=["EMPIRE1", "SLA113", "lyrica3", "universal"],
        description="Cultural vibe detection and matching",
        status="active",
        canon_lock=False,
        engine_type="revenue",
    ),
    "slang_engine": EngineMetadata(
        name="Slang Engine",
        service="app.services.slang",
        router="app.routers.engines.slang",
        credit_cost=8,
        enabled_for=["EMPIRE1", "SLA113", "Southern", "lyrica3"],
        description="Regional slang and dialect processing",
        status="active",
        canon_lock=False,
        engine_type="universal",
    ),
    "mode_engine": EngineMetadata(
        name="Mode Engine",
        service="app.services.mode",
        router="app.routers.engines.mode",
        credit_cost=12,
        enabled_for=["EMPIRE1", "SLA113", "lyrica3", "universal"],
        description="Musical mode and scale detection/generation",
        status="active",
        canon_lock=False,
        engine_type="revenue",
    ),
    "region_engine": EngineMetadata(
        name="Region Engine",
        service="app.services.region",
        router="app.routers.engines.region",
        credit_cost=10,
        enabled_for=["EMPIRE1", "SLA113", "Southern", "universal"],
        description="Geographic and cultural region detection",
        status="active",
        canon_lock=False,
        engine_type="universal",
    ),
    "seasonal_engine": EngineMetadata(
        ...
        service="app.services.seasonal",
        router="app.routers.engines.seasonal",
        credit_cost=8,
        enabled_for=["EMPIRE1", "SLA113", "Southern", "universal"],
        description="Seasonal content and trend adaptation",
        status="active",
        canon_lock=False,
        engine_type="universal",
    ),
    "filter_engine": EngineMetadata(
        name="Filter Engine",
        service="app.services.filter",
        router="app.routers.engines.filter",
        credit_cost=6,
        enabled_for=["EMPIRE1", "SLA113", "lyrica3", "universal"],
        description="Audio and content filtering system",
        status="active",
        canon_lock=False,
        engine_type="revenue",
    ),
