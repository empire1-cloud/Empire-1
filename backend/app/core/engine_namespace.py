...
CANON_ENGINES = {
    "canon_identity_v1": EngineMetadata(
        ...
        credit_cost=5,
        enabled_for=["SLA113", "EMPIRE1", "lyrica3", "universal"],  # SLA113 manufacture only — output delivered to Southern
    ...
    "aztec_chicano_engine": EngineMetadata(
        ...
        credit_cost=12,
        enabled_for=["SLA113", "EMPIRE1", "lyrica3", "universal"],
...
SLA113_CORE_ENGINES = {
    "playful_art_bible": EngineMetadata(
        ...
        router="app.routers.southern_engine_pack",
        credit_cost=0,
        enabled_for=["SLA113", "EMPIRE1", "lyrica3", "universal"],  # Canon-locked — SLA113 internal only, injected into Southern builds
        description=(
    ...
    "entropy_engine": EngineMetadata(
        ...
        router="app.routers.arcade",
        credit_cost=0,
        enabled_for=["SLA113", "EMPIRE1", "lyrica3", "universal"],  # Root kernel — /dev/shm only, governance-locked
        description=(
