...
class Fish:
    ...
    TIERS = [
        {"color": "#ff6600", "value": 10, "hp": 1},
        {"color": "#d4af37", "value": 25, "hp": 2},
        {"color": "#00c8ff", "value": 50, "hp": 3},
        {"color": "#ff4444", "value": 100, "hp": 4},
        {"color": "#44ff44", "value": 200, "hp": 5},
        {"color": "#9966ff", "value": 500, "hp": 8},
        {"color": "#ff00ff", "value": 1000, "hp": 12},
    ]
...
class Player:
    def __init__(self, ws, name: str, color: str):
        self.id = uuid.uuid4().hex[:8]
        self.ws = ws
        self.name = name
        self.color = color
...
class Lobby:
    ...
    async def add_player(self, ws, name: str) -> Player:
        import html
    ...
    async def _game_loop(self):
        ...
        while self.running:
            try:
                ...
                logger.error("Fish lobby game loop error: %s", e)
                await asyncio.sleep(0.1)

        logger.info("Fish lobby %s game loop stopped", self.id)
