...
const API = `${process.env.NEXT_PUBLIC_SLA113_BACKEND_URL || process.env.NEXT_PUBLIC_BACKEND_URL}/api/sla113`;
    ...
    <>
      ...
      <div className="sla113-scope flex h-screen w-full bg-[#050505] text-zinc-300 font-mono text-sm overflow-hidden select-none" data-testid="sla113-page">
        ...
        <aside className={`w-72 border-r bg-[#050505] flex flex-col shadow-2xl z-20 shrink-0 transition-colors duration-500 ${currentTheme.border}/30`} data-testid="sla113-sidebar">
          ...
          <button onClick={() => router.push('/')} className={`m-4 p-3 border border-zinc-800 text-zinc-500 text-[9px] uppercase tracking-widest hover:text-zinc-300 hover:border-zinc-600 transition-all`} data-testid="back-to-core">
            BACK TO CORE
          </button>
        </aside>
